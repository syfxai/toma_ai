...
const RecipeDisplay: React.FC<RecipeDisplayProps> = ({ recipe, uiText }) => {
  ...
  const handleDownloadTxt = () => {
    ...
    link.href = url;
    link.download = 'Toma_AI_Recipe.txt';
  ...
  const handleDownloadImage = async () => {
    ...
    if (canvas) {
        ...
        const link = document.createElement('a');
        link.href = image;
        link.download = 'Toma_AI_Recipe.png';
        document.body.appendChild(link);
        link.click();
        document.body.removeChild(link);
    }
  ...
  const handleShare = async () => {
    ...
    try {
        ...
        const fileName = 'Toma_AI_Recipe.png';
        const imageFile = new File([blob], fileName, { type: 'image/png' });
        
        const shareData = {
            files: [imageFile],
            title: `Toma AI Recipe: ${recipe.recipeName}`,
            text: `Recipe from Toma AI: ${recipe.recipeName}`,
        };
  ...
  return (
    <>
      ...
      {/* Hidden components for clean image export, one for each layout */}
